...
<?php if ($params->get('show_create_date')) : ?>
		<dd class="create">
		<?php 
				$date = JHtml::_('date', $this->item->created, 'U'); 
				echo strftime (JText::_('DATE_FORMAT_LC_BUSINESS'), $date);
			?>
		</dd>
<?php endif; ?>
...
<?php if ($params->get('show_author') && !empty($this->item->author)) : ?>
		...
		<?php $author = ($this->item->created_by_alias ? $this->item->created_by_alias : $author);?>
			...
			<?php 	$needle = 'index.php?option=com_contact&view=contact&id=' . $this->item->contactid;
...
<?php endif; ?>
	...
	<div class="content-article clearfix"><?php echo $this->item->text; ?></div>
