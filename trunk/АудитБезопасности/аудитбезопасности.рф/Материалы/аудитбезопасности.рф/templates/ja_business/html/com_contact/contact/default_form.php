...
<div class="contact-form">
    <form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate">
        <fieldset>
            ...
            <div class="clear contact-row">
                <dl><dt><?php echo $this->form->getLabel('contact_subject'); ?></dt>
                    <dd><?php echo $this->form->getInput('contact_subject'); ?></dd>
                </dl>
            </div>
            <div class="clear contact-row">
                <dl>
                    <dt class="contact-mess"><?php echo $this->form->getLabel('contact_message'); ?></dt>
                    <dd class="contact-mess"><?php echo $this->form->getInput('contact_message'); ?></dd>
                </dl>
            </div>
            ...
            <?php } ?>
            <div class="clear">
                <dl><dd><button class="button validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
